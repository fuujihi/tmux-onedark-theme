...
set "window-status-current-format" " #[fg=$onedark_green,bg=$onedark_window_black,bold]#{?client_prefix,#[fg=$onedark_red],} #I#[fg=$onedark_visual_grey]:#[fg=$onedark_visual_grey]#W#[fg=$onedark_comment_grey]#F "
