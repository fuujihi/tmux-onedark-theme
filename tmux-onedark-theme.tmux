...
set "status-left" "#[fg=$onedark_black,bg=$onedark_green] #S #[fg=$onedark_green,bg=$onedark_black_deep,nobold,nounderscore,noitalics]#[fg=$onedark_visual_grey,bg=$onedark_black_deep]#I  #P"
