...
set "status-right" "#[fg=$onedark_white,bg=$onedark_black_deep,nounderscore,noitalics]${time_format}  ${date_format} #[fg=$onedark_visual_grey,bg=$onedark_black_deep]#[fg=$onedark_visual_grey,bg=$onedark_visual_grey]#[fg=$onedark_white, bg=$onedark_visual_grey]${status_widgets} #[fg=$onedark_green,bg=$onedark_visual_grey,nobold,nounderscore,noitalics]#[fg=$onedark_black,bg=$onedark_green,bold] #h "
...
set "window-status-format" "#[fg=$onedark_black_deep,bg=$onedark_black_deep,nobold,nounderscore,noitalics]#[fg=$onedark_white,bg=$onedark_black_deep] #I  #W #[fg=$onedark_black_deep,bg=$onedark_black_deep,nobold,nounderscore,noitalics]"
