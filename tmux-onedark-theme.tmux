...
set "status-left" "#[fg=$onedark_black,bg=$onedark_green] #S #[fg=$onedark_black_deep,bg=$onedark_black_deep,nobold,nounderscore,noitalics]#[fg=$onedark_black_deep,bg=$onedark_black_deep,nounderscore,noitalics]#[fg=$onedark_white,bg=$onedark_black_deep]#I."

set "window-status-format" " #[fg=$onedark_comment_grey,bg=$onedark_black_deep] #I: #W "
set "window-status-current-format" " #[fg=$onedark_white,bg=$onedark_window_black,bold]#{?client_prefix,#[fg=$onedark_red],} #I: #W "
